...
public class LetterInventory {
	...
	//Throws IllegalArgumentException if the letter given isn't a letter
	//Returns the percent of all characters that are the same as the letter passed
	public double getLetterPercentage(char letter) {
		if(!isLetter(letter)) {
			throw new IllegalArgumentException("Letter given not valid");
		}
		
		return ((double) (this.inventory[letter - 'a']/size)) * 100;
	}
